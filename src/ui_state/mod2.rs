...
impl MiddleLevelUiControlState {
    ...
    pub fn on_event<T: MiddleLevelUiContext>(
        self,
        ev: ControlStateEvent,
        ctx: &mut T,
    ) -> Option<Self> {
        match self {
            MiddleLevelUiControlState::Pressed { timeout, data } => match ev {
                ControlStateEvent::Press => panic!(),
                ControlStateEvent::Release => Some(
                    MiddleLevelUiControlState::MiddleLevelUiControlClicked::new(ctx),
                ),
                ControlStateEvent::Timeout => {
                    Some(MiddleLevelUiControlState::MiddleLevelUiControlLongPressed::new(ctx))
                }
            },
            MiddleLevelUiControlState::LongPressed { data } => match ev {
                ControlStateEvent::Press => panic!(),
                ControlStateEvent::Release => {
                    Some(MiddleLevelUiControlState::MiddleLevelUiControlLongClicked::new(ctx))
                }
                ControlStateEvent::Timeout => panic!(),
            },
            MiddleLevelUiControlState::Clicked { timeout, data } => match ev {
                ControlStateEvent::Press => {
                    Some(MiddleLevelUiControlState::MiddleLevelUiPressed::new(ctx))
                }
            ...
            MiddleLevelUiControlState::LongClicked { timeout, data } => match ev {
                ControlStateEvent::Press => {
                    Some(MiddleLevelUiControlState::MiddleLevelUiPressed::new(ctx))
                }
                ControlStateEvent::Release => panic!(),
